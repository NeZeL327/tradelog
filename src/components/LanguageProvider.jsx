  ...
  useEffect(() => {
    ...
    const allTranslations = {
      pl: {
        ...
        billingSyncError: "Nie udało się zaktualizować statusu subskrypcji",
        billingPortalError: "Nie udalo sie otworzyc panelu subskrypcji",
        billingCancel: "Anuluj subskrypcję",
        billingCancelling: "Anulowanie...",
        billingCancelConfirm: "Czy na pewno chcesz anulować subskrypcję na koniec bieżącego okresu?",
        billingCancelSuccess: "Subskrypcja zostanie anulowana na koniec bieżącego okresu.",
        billingCancelError: "Nie udało się anulować subskrypcji",
        billingCancellationScheduled: "Anulowanie zaplanowane na koniec bieżącego okresu.",
        ...
        billingActiveWithFirstPayment: "Subskrypcja aktywna. Pierwsza płatność:",
        billingActiveNextPayment: "Subskrypcja aktywna. Następna płatność:",
      ...
      en: {
        ...
        billingSyncError: "Unable to refresh subscription status",
        billingPortalError: "Unable to open billing portal",
        billingCancel: "Cancel subscription",
        billingCancelling: "Cancelling...",
        billingCancelConfirm: "Are you sure you want to cancel your subscription at the end of the current period?",
        billingCancelSuccess: "Your subscription will be canceled at the end of the current period.",
        billingCancelError: "Unable to cancel subscription",
        billingCancellationScheduled: "Cancellation scheduled for the end of the current period.",
        ...
        billingActiveWithFirstPayment: "Subscription active. First payment on:",
        billingActiveNextPayment: "Subscription active. Next payment on:",
