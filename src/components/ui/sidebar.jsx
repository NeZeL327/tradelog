    ...
    (<SidebarContext.Provider value={contextValue}>
      <TooltipProvider delayDuration={0}>
        <div
          ...
          className={cn(
            "group/sidebar-wrapper flex min-h-full h-full w-full has-[[data-variant=inset]]:bg-sidebar",
            className
          )}
          ref={ref}
          {...props}>
...
const Sidebar = React.forwardRef((
  ...
  return (
    (<div
      ...
      <div
        className={cn(
          "relative h-full min-h-full w-[--sidebar-width] bg-transparent transition-[width] duration-200 ease-linear",
      ...
      <div
        ...
        <div
          data-sidebar="sidebar"
          className="flex h-full w-full flex-col bg-sidebar relative overflow-hidden group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow">
          {children}
        </div>
      </div>
    </div>)
